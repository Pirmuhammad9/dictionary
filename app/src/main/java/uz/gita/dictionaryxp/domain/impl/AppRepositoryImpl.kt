...
import uz.gita.dictionaryxp.domain.AppRepository

class AppRepositoryImpl : AppRepository {
    val database: MyDatabase = MyDatabase.getDatabase()
    companion object {
    ...
    override fun addtoFavourite(id: Int, favourite: Int) = flow<Unit> {
        database.addToFavourite(id, favourite)
    }.catch {
    }.flowOn(Dispatchers.IO)

    override fun addToNote(id: Int, note: String) = flow<Unit> {
